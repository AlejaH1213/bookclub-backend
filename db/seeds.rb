...
user2 = User.where(email: "mark.twain@example.com").first_or_create(
  ...
  club1 = Club.create(
    ...
    summary: "A club for fans of epic fantasy literature. Join us in exploring magical realms and heroic adventures filled with dragons and more.",
  ...
  club2 = Club.create(
    ...
    summary: "Dive into the world of non-fiction literature. We explore topics ranging from history to science and self-help. Everyone is welcomed",
  ...
  club3 = Club.create(
    ...
    summary: "Travel back in time with us to explore different eras, events, and figures in history through literature. From the past to the present",
...
p "user2 memberships", user2.memberships
